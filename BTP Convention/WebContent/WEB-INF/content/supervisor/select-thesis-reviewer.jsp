...
<body>
	...
	<s:form id="reviewer" action="submit-reviewers" theme="bootstrap">
		<div class="col-sm-6">
			<h3>Indian Reviewers</h3>
			<hr />
			<div class="col-xs-3">
				<!-- required for floating -->
				<!-- Nav tabs -->
				<ul class="nav nav-tabs tabs-left sideways">
					<li class="active"><a href="#t1" data-toggle="tab">Reviewer-1</a></li>
					<li><a href="#t2" data-toggle="tab">Reviewer-2</a></li>
					<li><a href="#t3" data-toggle="tab">Reviewer-3</a></li>
					<li><a href="#t4" data-toggle="tab">Reviewer-4</a></li>
					<li><a href="#t5" data-toggle="tab">Reviewer-5</a></li>
				</ul>
			</div>
			...
			<div class="col-xs-9">
				...
				<div class="tab-content ml-5">
					<div class="tab-pane active" id="t1">
						<s:url var="remoteurl" action="get-reviewer-emails" />
						<div class="card-body">
							<sj:select href="%{remoteurl}" list="reviewerIndianEmails"
								id="r1" headerKey="-1" name="reviewersIndianEmail"
								headerValue="Please Select a reviewer" />
							<br />
							<s:textfield id="r1Name" label="Name"></s:textfield>
							<s:textfield id="r1Designation" label="Designation"></s:textfield>
					...
					<div class="tab-pane" id="t2">
						<div class="card-body">
							<s:url var="remoteurl" action="get-reviewer-emails" />
							<sj:select href="%{remoteurl}" list="reviewerIndianEmails"
								id="r2" headerKey="-1" name="reviewersIndianEmail"
								headerValue="Please Select a reviewer" />
							<br />
							<s:textfield id="r2Name" label="Name"></s:textfield>
							<s:textfield id="r2Designation" label="Designation"></s:textfield>
					...
					<div class="tab-pane" id="t3">
						<div class="card-body">
							<s:url var="remoteurl" action="get-reviewer-emails" />
							<sj:select href="%{remoteurl}" list="reviewerIndianEmails"
								id="r3" headerKey="-1" name="reviewersIndianEmail"
								headerValue="Please Select a reviewer" />
					...
					<div class="tab-pane" id="t4">
						<div class="card-body">
							<s:url var="remoteurl" action="get-reviewer-emails" />
							<sj:select href="%{remoteurl}" list="reviewerIndianEmails"
								id="r4" headerKey="-1" name="reviewersIndianEmail"
								headerValue="Please Select a reviewer" />
							<br />
							<s:textfield id="r4Name" label="Name"></s:textfield>
							<s:textfield id="r4Designation" label="Designation"></s:textfield>
					...
					<div class="tab-pane" id="t5">
						<div class="card-body">
							<s:url var="remoteurl" action="get-reviewer-emails" />
							<sj:select href="%{remoteurl}" list="reviewerIndianEmails"
								id="r5" headerKey="-1" name="reviewersIndianEmail"
								headerValue="Please Select a reviewer" />
							<br />
							<s:textfield id="r5Name" label="Name"></s:textfield>
							<s:textfield id="r5Designation" label="Designation"></s:textfield>
		...
		<div class="col-sm-6">
			<h3>Abroad Reviewers</h3>
			<hr />
			<div class="col-xs-3">
				<!-- required for floating -->
				<!-- Nav tabs -->
				<ul class="nav nav-tabs tabs-left sideways">
					<li class="active"><a href="#t6" data-toggle="tab">Reviewer-1</a></li>
					<li><a href="#t7" data-toggle="tab">Reviewer-2</a></li>
					<li><a href="#t8" data-toggle="tab">Reviewer-3</a></li>
					<li><a href="#t9" data-toggle="tab">Reviewer-4</a></li>
					<li><a href="#t10" data-toggle="tab">Reviewer-5</a></li>
				</ul>
			</div>
